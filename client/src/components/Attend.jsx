                        ...
                        <Navbar.Collapse>
                            ...
                            <Row className='justify-content-center w-100'>
                                {localStorage.getItem('manageIdRole') === '1' ?
                                    <h6 className='text-center pt-3' style={{ color: "white" }}>Điểm danh hằng ngày</h6>
                                    :
                                    <h6 className='text-center pt-3' style={{ color: "white" }}>Chấm công</h6>}
                            </Row>
