                        ...
                        <Navbar.Collapse>
                            ...
                            <Row className='justify-content-center w-100'>
                                {localStorage.getItem('manageIdRole') === '1' ?
                                    <h6 className='text-center pt-3' style={{ color: "white" }}>Thông tin học viên</h6>
                                    :
                                    <h6 className='text-center pt-3' style={{ color: "white" }}>Thông tin giảng viên</h6>}
                            </Row>
